	...
	<div class="container">
		...
		<div class="g-between">
			...
			<div style="width: 50%; padding: 50px;">
				<h2>대표이사 김진호</h2>
				<br> <br> <br> 우리는 꿈을 현실로 만드는 여정에 함께하는 동반자들이다.<br>
				우리는 사람들이 자신의 꿈을 실현하는 것을 도움으로써 더 나은 세상을 만드는데 기여한다.<br> <br>
				<br>꾸준히 노력을 쌓아온 사람만이 사회에서 그 능력을 인정받지요.<br> 특히 IT업계로의 진입은
				더더욱 어렵고 힘들게 느끼실 수도 있어요.<br> 그러나 포기하지 않고 나에게 주어진 퀘스트를 하나씩 완료할수록
				본인의 능력치 향상뿐만 아니라 자신감이 붙을 거예요.<br> 이렇게 자신감을 갖고 노력하다 보면, 어느 순간
				개발자로서 어엿한 사회 구성원이 되어있는 나 자신을 발견하는 날이 올 것입니다 :)<br><br>  개발자가 되는 그
				날까지 함께 완주하겠습니다 하루가 멀다하고 쏟아지는 새로운 기술들과 하나하나 이해하기 어려운 용어들,<br>  많은 사람들이 IT
				분야는 공부할 것도 많고 어렵다라고 말하기도 합니다.<br>  하지만 목표가 뚜렷한 사람에게 그 많은 기술들은 공부해야 할 과제가
				아니라 좋은 도구이자 설레이는 장난감일 뿐 입니다.<br>  '쇼핑몰을 만들겠다, 게임을 만들겠다, 해킹툴을 만들겠다' 무엇이든
				좋습니다. 욕심과 목표를 가지세요. 그것은 우리를 강하게 합니다.<br>  본인이 상상하는 IT 전문가의 모습이 있다면 확신해도
				좋습니다.<br>  우린 그렇게 됩니다.<br> 
			</div>
		</div>
		<div class="g-between">
