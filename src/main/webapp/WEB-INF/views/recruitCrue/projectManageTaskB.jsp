...
<meta charset="UTF-8">
<title>Project Task Manager_Bug</title>
	...
	$(function(){
	    ...
	    $(".rBox_Leftnavi_left").click(function(){
	    	if($(".navi_checkbox").is(":checked")){
				location.href="/enterTaskBSelect.do?reqPage=1&viewValue=1&checkValue=2&projectNo="+pageProjectNo+"&teamMemberNo="+pageTeamMemberNo;
			} else {
				location.href="/enterTaskBSelect.do?reqPage=1&viewValue=1&checkValue=1&projectNo="+pageProjectNo+"&teamMemberNo="+pageTeamMemberNo;
			}
	    });
	    
		$(".rBox_Leftnavi_middle").click(function(){
			if($(".navi_checkbox").is(":checked")){
				location.href="/enterTaskBSelect.do?reqPage=1&viewValue=2&checkValue=2&projectNo="+pageProjectNo+"&teamMemberNo="+pageTeamMemberNo;
			} else {
				location.href="/enterTaskBSelect.do?reqPage=1&viewValue=2&checkValue=1&projectNo="+pageProjectNo+"&teamMemberNo="+pageTeamMemberNo;
			}
		 });
		
		$(".rBox_Leftnavi_right").click(function(){
			if($(".navi_checkbox").is(":checked")){
				location.href="/enterTaskBSelect.do?reqPage=1&viewValue=3&checkValue=2&projectNo="+pageProjectNo+"&teamMemberNo="+pageTeamMemberNo;
			} else {
				location.href="/enterTaskBSelect.do?reqPage=1&viewValue=3&checkValue=1&projectNo="+pageProjectNo+"&teamMemberNo="+pageTeamMemberNo;
			}
		 });
		$(".rBox_Leftnavi_first").click(function(){
			if($(".navi_checkbox").is(":checked")){
				location.href="/enterTaskBSelect.do?reqPage=1&viewValue=4&checkValue=2&projectNo="+pageProjectNo+"&teamMemberNo="+pageTeamMemberNo;
			} else {
				location.href="/enterTaskBSelect.do?reqPage=1&viewValue=4&checkValue=1&projectNo="+pageProjectNo+"&teamMemberNo="+pageTeamMemberNo;
			}
		 });
                ...
                <ul>
                    ...
                    <li class="flexCLi" style="border-bottom: 3px dashed #90d1b4; cursor: pointer;">
	                    ...
	                    <ul class="s-sub-menu">
                            ...
                            <li><a href="/enterProjectTaskB.do?projectNo=${projectNo}&reqPage=1"><span style="cursor: pointer; color: #90d1b4; font-weight: 900;">Bug</span></a></li>
                        ...
                        <div class="taskMeeting">
	                        <a data-bs-toggle="modal" href="#${ptk.taskNo}" style="text-decoration: none;display: block;width:100%;" class="modalClassBtn">
	                                ...
	                                <div class="rightTaskSite" style="width:330px; display: flex;">
	                                    ...
	                                    <a href="/deleteTask.do?taskNo=${ptk.taskNo}&projectNo=${projectNo}&taskType=3" class="hoverImg"><img src="/resources/img/recruitTeamProject/common/delete.png" style="width: 30px; height: 30px; position: relative; bottom: 3px;"></a>
	                                </div>
	                        	</a>
	                        </div>
                        </c:forEach>
