...
<script>
	...
	$(function(){
		...
		$('#maxContentPost').on("DOMSubtreeModified", function(){
	...
	<div class="container" id="projectContainer">
		<div class="main">
            ...
            <div class="main_content">
	            <form action="/updateRecruitNotice.do?memberNo=${pt.projectWriterMemberNo }&projectNo=${pt.projectNo}" method="post" enctype="multipart/form-data" onsubmit="return checkValue();">
		            <div class="writeBox">
	                    <div class="form-group">
	                        <input class="form-control form-control-lg" type="text" id="inputLarge" name="rTitle" maxlength="30" value="${pt.RTitle}">
	                    </div>
	                    <div class="writeLine">
	                    ...
	                    <div class="writeLine">
	                        ...
	                        <input type="text" id="datePicker" class="form-control" name="rEndDate" value="${pt.REndDate}">
	                    ...
	                    <div class="writeLine">
	                        ...
	                        <div class="form-group">
	                            <input type="text" class="form-control" id="inputDefault" name="projectName" maxlength="40" value="${pt.projectName}">
	                        </div>
	                    </div>
	                    <div class="line"></div>
	                    <div class="writeLine">
	                        ...
	                        <div class="form-group">
	                            <input type="text" class="form-control" id="inputDefault" name="projectGoal" maxlength="60" value="${pt.projectGoal}">
	                        </div>
	                    </div>
	                    <div class="line"></div>
	                    <div class="writeLine">
	                        ...
	                        <div class="form-group">
	                            <textarea class="form-control" id="summernote" rows="3" name="rContent" value="${pt.RContent }"></textarea>
	                        </div>
	                    </div>
