	...
	<div class="container" id="projectContainer">
		<div class="main">
            ...
            <div class="main_content">
	            <form action="/insertApplyProject.do" method="post" enctype="multipart/form-data" onsubmit="return checkValue();">
		            <div class="writeBox">
	                    <div class="form-group">
	                        <input class="form-control form-control-lg" type="text" placeholder="짧은 포부를 전달해주세요!" id="inputLarge" name="ambition" maxlength="30">
	                    </div>
	                    <div class="writeLine">
