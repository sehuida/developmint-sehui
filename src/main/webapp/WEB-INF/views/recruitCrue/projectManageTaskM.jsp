                        ...
                        <div class="taskMeeting">
	                        <a data-bs-toggle="modal" href="#${ptk.taskNo}" style="text-decoration: none;display: block;width:100%;" class="modalClassBtn">
	                                ...
	                                <div class="rightTaskSite" style="width:330px; display: flex;">
	                                    ...
	                                    <a href="/deleteTask.do?taskNo=${ptk.taskNo}&taskType=1" class="hoverImg"><img src="/resources/img/recruitTeamProject/common/delete.png" style="width: 30px; height: 30px; position: relative; bottom: 3px;"></a>
	                                </div>
	                        	</a>
	                        </div>
                        </c:forEach>
