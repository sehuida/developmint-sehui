...
<body>
	...
	<div class="container" style="margin-bottom: 100px">
		...
		<%--댓글 입력 창(로그인했을 때 띄우기) : form action, 맨밑에 input 두개 해당 게시판으로 고치기/ 댓글 등록할 때 SQL에서 등록일 to_char(SYSDATE,'MM-DD HH24:MI') 이걸로 넣어주세용--%>
										...
										<div class="recommentImgBox">
											<c:choose>
												<c:when test="${rl.memberImg eq null }">
													<img src="/resources/img/member/user.png" style="width: 30px; height:30px;">				
												</c:when>
												<c:otherwise>
													<img src="/resources/upload/member/${rl.memberImg }" style="width: 30px; height:30px; border-radius: 50%">
												</c:otherwise>
											</c:choose>
										</div>
										<div class="iddate">
