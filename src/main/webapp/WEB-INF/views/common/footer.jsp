			...
			<div style="overflow:hidden;" class="row">
				...
				<div style="text-align: right;" >
					<ul class="list-unstyled pe-5" style="float: left;font-size: large;">고객센터
						<li ><a href="#" style="color:#737373;font-size: medium;">공지사항</a></li>
						<li><a href="#" style="color:#737373;font-size: medium;">1:1문의</a></li>
					</ul>
					<ul class="list-unstyled pe-5" style="float: left">
						<li ><a href="#" style="color:black;">팀프로젝트 팀원모집</a></li>
						<li><a href="#" style="color:black;">'고수'의 노하우</a></li>
						<li><a href="#" style="color:black;">개발지식공유</a></li>
						<li><a href="#" style="color:black;">공모전</a></li>
					</ul>
					<a href="/"><img src="/resources/img/logo/Develomint_logo.png"></a><br>
					<sapn><a href="#" style="color:black;">이용약관</a> <a href="#" style="color:black;">개인정보취급방침</a> <a href="#" style="color:black;">인재채용</a> <a href="#" style="color:black;">제휴문의</a></sapn>
					<p>대표이사 | 이윤수</p>
